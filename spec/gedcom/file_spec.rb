...
describe Gedspec::Gedcom::File do
  ...
  it 'extracts head snippet' do
    expect(file.head).to be_kind_of(String)
    expect(file.head).to eq fixture_content('tgc551_head.ged')
  end
  ...
  it 'extracts all repo snippets' do
    expect(file.repo).to be_kind_of(String)
    expect(file.repo).to eq fixture_content('tgc551_r1.ged')
  end
  ...
  it 'extracts all obje snippets' do
    expect(file.obje).to be_kind_of(String)
    expect(file.obje).to eq fixture_content('tgc551_m1.ged')
  end
end
